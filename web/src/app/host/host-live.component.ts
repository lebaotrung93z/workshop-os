...
@Component({
  ...
  styles: `
    ...
    .step {
      ...
      border: 1px solid var(--bosch-border);
      border-left: 4px solid var(--bosch-gray-70);
      display: grid;
      gap: 0.65rem;
    ...
    .step--done {
      border-left-color: var(--bosch-positive);
    }
    ...
    .step--pending {
      border-left-color: var(--bosch-gray-70);
      opacity: 0.85;
    }
    ...
    .step--done .step__num {
      background: var(--bosch-positive);
      border-color: var(--bosch-positive);
      color: var(--bosch-on-accent);
    }
