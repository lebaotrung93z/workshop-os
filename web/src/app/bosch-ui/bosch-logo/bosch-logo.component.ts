...
import { boschBaseColors, boschBrandRed } from '../../data/bosch-brand-colors';

const boschLogoRed = boschBrandRed[50];
const boschSymbolBlack = boschBaseColors.black;

@Component({
  selector: 'app-bosch-logo',
  standalone: true,
  template: `
    <svg
      class="bosch-brand-logo"
      viewBox="0 0 433 97"
      ...
      focusable="false"
    >
      <g class="bosch-brand-logo__symbol" [attr.fill]="symbolBlack" fill-rule="evenodd">
        <path
          [attr.fill]="symbolBlack"
      ...
      <g class="bosch-brand-logo__word" [attr.fill]="logoRed" fill-rule="evenodd">
        <path
          [attr.fill]="logoRed"
...
export class BoschLogoComponent {
  protected readonly logoRed = boschLogoRed;
  protected readonly symbolBlack = boschSymbolBlack;
}
