...
@Component({
  ...
  `,
  styles: `
    .page { display: grid; gap: 0.85rem; margin: 0 auto; max-width: 480px; padding: 1rem; }
    .top { align-items: center; display: flex; justify-content: space-between; }
    .me { align-items: center; color: var(--bosch-text-secondary); display: inline-flex; font-size: 0.9rem; font-weight: 600; gap: 0.45rem; }
    h1 { font-size: 1.25rem; margin: 0; }
    .status { color: var(--bosch-text-muted); margin: 0; }
    .options, .vote-list { display: grid; gap: 0.5rem; }
    .groups { display: flex; flex-wrap: wrap; gap: 0.4rem; margin-bottom: 0.75rem; }
    .g { background: var(--bosch-surface); border: 1px solid var(--bosch-border-strong); padding: 0.4rem 0.6rem; }
    .g.on { background: var(--bosch-accent-soft); border-color: var(--bosch-accent); }
    textarea, input { border: 1px solid var(--bosch-border-strong); box-sizing: border-box; font: inherit; margin-bottom: 0.65rem; padding: 0.65rem; width: 100%; }
    label { display: grid; font-weight: 600; gap: 0.25rem; }
    .owner-row { align-items: center; display: grid; gap: 0.5rem; grid-template-columns: auto 1fr; }
    .owner-row input { margin-bottom: 0; }
    .vote { background: var(--bosch-yellow-95); border: 1px solid var(--bosch-border); display: grid; gap: 0.45rem; padding: 0.75rem; text-align: left; }
    .vote__meta { align-items: center; display: flex; gap: 0.4rem; font-size: 0.82rem; font-weight: 600; }
    .vote p { margin: 0; }
    .vote__cta { color: var(--bosch-accent); font-size: 0.78rem; font-weight: 700; }
